...
## Post-hoc-Tests: Welche Gruppen unterscheiden sich? (1)
...
**Wichtig:** Die One-Way ANOVA für `mean_rl_all` ist nicht signifikant!

Deswegen wären Post-hoc-Tests hier inhaltlich nicht notwendig und nicht durchzuführen.

→ Wir zeigen sie hier zu Übungszwecken trotzdem, um die Syntax von:

-   `emmeans()`

-   und `pairs()` kennenzulernen.

------------------------------------------------------------------------

## Post-hoc-Tests: Welche Gruppen unterscheiden sich? (2)
...
| Unterscheiden sich die Veränderungen zwischen den Gruppen? | Veränderungsscores zwischen den Gruppen vergleichen |
...
Diese modellbasierten Mittelwerte aus dem ANOVA-Modell sind die Grundlage für die folgenden Paarvergleiche.
...
## Möglichkeit 3: Direkter Vergleich der Veränderungen (1)
...
## Möglichkeit 3: Direkter Vergleich der Veränderungen (2)

<br>

Nun berehcnen wir die Veränderung von `pre1` zu `pre4` innerhalb jeder Gruppe:
...
## Möglichkeit 3: Direkter Vergleich der Veränderungen (3)
