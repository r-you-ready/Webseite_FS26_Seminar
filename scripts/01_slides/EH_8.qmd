...
## Kombination select() und full_join()
...
👉 Sortiert Daten nach einer Variable\
...
Fehlende Werte entstehen rein zufällig & haben keinem Zusammenhang mit anderen Daten
...
→ Fehlende Werte werden in die Berechnung miteinbezogen (default-Einstellung); ergibt NA als Mittelwert
