...
**Ist das ein echter Effekt – oder nur Zufall?**
...
→ Ist dieser Zusammenhang wirklich da oder bloss ein Zufall in unseren Daten?
...
-   zu überprüfen, ob Effekte wirklich existieren
...
Die Wahl des statistischen Tests hängt ab von:
...
👉 Diese helfen euch, den passenden Test systematisch auszuwählen.
...
-   **ANOVA** → Unterschiede zwischen mehreren Gruppen
