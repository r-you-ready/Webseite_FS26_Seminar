...
In diesem Seminar arbeiten wir hauptsächlich mit `.csv`- und `.xlsx`-Dateien. Wir werden und mehrere Möglichkeiten anschauen, wie man diese einlesen kann.

👉 [Kapitel 3.2](https://methodenlehre.github.io/einfuehrung-in-R/chapters/03-data_frames.html#daten-importieren)

👉 [Cheatsheat Datenimport mit `readr`](https://rstudio.github.io/cheatsheets/html/data-import.html)
...
👉Für das Einlesen weiterer Dateiforate (z.B. SPSS-Dateien), siehe [Kapitel 3.2](https://methodenlehre.github.io/einfuehrung-in-R/chapters/03-data_frames.html#daten-importieren)
:::
