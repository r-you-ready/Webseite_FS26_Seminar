...
-   **Hilfefunktion und Formatierung:** Schau dir die Hilfefunktion an und nimm Formatierungen vor, wie etwa die Umbenennung der Spalten mit `col.names(c(„new colnames here “))`, die Anpassung der Nachkommastellen auf 2 mit `digit =`, das Ergänzen einer Überschrift mit `caption =`
...
-   **Speichern der Tabelle:** Speichere die Tabelle in einer Word Datei mit der Ergänzung `filename = "somefilename.doc"` im Ordner outputs?
